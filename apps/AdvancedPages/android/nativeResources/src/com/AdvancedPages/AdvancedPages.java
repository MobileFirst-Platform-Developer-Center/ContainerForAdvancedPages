...
public class AdvancedPages extends CordovaActivity implements WLInitWebFrameworkListener {
	...
	/**
	 * The IBM MobileFirst Platform web framework calls this method after its initialization is complete and web resources are ready to be used.
	 */
 	public void onInitWebFrameworkComplete(WLInitWebFrameworkResult result){
		if (result.getStatusCode() == WLInitWebFrameworkResult.SUCCESS) {
			//super.loadUrl(WL.getInstance().getMainHtmlFilePath());
			WL.getInstance().hideSplashScreen();
			super.loadUrl("http://localhost:10080/conference/common/logon.jsp");
