...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions 
{
    ...
    // By default splash screen will be automatically hidden once MobileFirst Platform JavaScript framework is complete. 
...
-(void)wlInitDidCompleteSuccessfully
{
    ...
    NSString* remoteURLStr= @"http://localhost:10080/conference/common/logon.jsp";
